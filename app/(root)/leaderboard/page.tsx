          ...
          <div className='w-full my-3 px-3'>
            <div className='flex flex-col w-full bg-blue-800 rounded-xl p-2 justify-center items-center'>
              <div className='flex flex-row items-center gap-3'>
                ...
                <p className='text-[25px] font-bold text-yellow-300 my-3'>Round 34</p>
                <Image src={'/assets/icons/trophy-yellow.svg'} alt='trophy' height={25} width={25}/>
              </div>
                  ...
                  return (
                    <li key={poll._id} className='min-h-[380px] min-w-[280px] flex flex-col'>
                      <div className='relative'>
                        ...
                        <div className='absolute top-2 left-2 bg-yellow-300 border-2 border-blue-800 p-2 rounded-full flex items-center justify-center w-10 h-10'>
                          <p className='text-blue-800 font-bold'>{index + 1}</p>
                        </div>
                      </div>
                      <div className='bg-white h-[150px] max-w-[280px] rounded-b-lg py-1 flex flex-col'>
                        ...
                        <div className='flex w-full'>
                          <p className='ml-auto mr-5 border-2 border-yellow-300 bg-blue-600 text-yellow-300 py-1 px-2 rounded-lg font-semibold'>{(poll.nofVotes).toLocaleString()} Votes</p>
                        </div>
                      </div>
                    </li>
                  )
