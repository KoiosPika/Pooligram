        ...
        <div className='w-full p-3 bg-white m-3 rounded-lg items-center'>
            <div className='flex flex-col gap-2'>
                ...
                <div className='flex flex-row gap-1 items-center my-2'>
                    <Link href={`/poll/${poll._id}`} className='sm:min-h-[300px] sm:min-w-[300px] min-h-[150px] min-w-[150px] bg-slate-200 rounded-md'>
                    ...
                    <div className='flex flex-col justify-center items-center ml-2 mt-auto w-full gap-2'>
                        ...
                        <p className='w-full text-center py-1 px-2 rounded-lg inline-block font-semibold bg-blue-300 text-blue-800 text-[14px]'>Votes : {poll.nofVotes}</p>
