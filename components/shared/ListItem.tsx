        ...
        <div className='w-full p-3 bg-white m-3 rounded-lg items-center'>
            <div className='flex flex-col gap-2'>
                ...
                <div className='flex flex-row gap-1 items-center my-2'>
                    <Link href={`/poll/${poll._id}`} className='sm:min-h-[300px] sm:min-w-[300px] min-h-[150px] min-w-[180px] bg-slate-200 rounded-md'>
                        <Image src={poll.imageUrl} alt='hero' width={300} height={300} className='rounded-md sm:h-[300px] sm:w-[300px] h-[200px] w-[250px]' />
                    </Link>
                    <div className='flex flex-col justify-center items-center ml-2 mt-auto w-full gap-2'>
                        ...
                        <Button className='bg-yellow-500 flex flex-row items-center gap-1 w-full hover:bg-yellow-500'>
